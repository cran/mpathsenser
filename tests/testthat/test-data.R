...
test_that("Accelerometer", {
 db_test("Accelerometer", true_data = tibble::tibble(
  measurement_id = c("15d06c62-3b69-5a1d-21b1-bf82ddc573bf_1",
                     paste0("268f6135-70ac-f96a-f800-0d8f6bb6ffa6_", 1:5)),
  participant_id = "12345",
  date = "2021-11-14",
  time = c("13:59:59.000", "14:00:00.000", "14:00:00.200",
           "14:00:00.400", "14:00:00.600",  "14:00:00.800"),
  x = c(NA, -0.45947299565606, -0.31261359042355, -0.92950401127219,
        -0.57727191720589, -0.29951507561905),
  y = c(NA, 0.66402153964424, 0.37969748447006, 0.40856299984702,
        0.91639749921748, 0.362559743517898),
  z = c(NA, 9.34531187528098, 9.19530456721872, 9.55071386678994,
        9.861390738568486, 9.38065402300287)
 ))
})
...
test_that("AirQuality", {
 db_test("AirQuality", true_data = tibble::tibble(
  measurement_id = c("d8dc5bea-6184-bafb-d65c-0a180aa21eb0",
...
test_that("InstalledApps", {
 db_test("InstalledApps", true_data = tibble::tibble(
  measurement_id = c("b7eacaef-a4ff-90c0-c5a2-7e293dee7721_1",
                     paste0("c48c62ac-a738-0ee0-586d-29ab0acff25a_", 1:16)),
  participant_id = "12345",
  date = "2021-11-14",
  time = c("13:59:59", rep("14:00:00", 16)),
  app = c(NA, "WhatsApp", "Google Play Services for AR", "BBC News", "Clock", "Google Play Music",
...
test_that("AppUsage", {
 db_test("AppUsage", true_data = tibble::tibble(
  measurement_id = c("2c3de6bf-e63d-4c47-8d14-36b9505d8968_1",
  ...
  app = c("", "kuleuven", "securitycenter", "home", "systemui",
...
test_that("Battery", {
 db_test("Battery", true_data = tibble::tibble(
  measurement_id = c("1cc3b19c-a56a-ebc0-cd55-d5faf928c6c8",
...
test_that("Bluetooth", {
 db_test("Bluetooth", true_data = tibble::tibble(
  measurement_id = c(paste0("fff452f8-f927-86ca-b853-5236f25ec7dd_", 1:2),
                     "88cf67a2-16d0-e7cc-2be5-6296d7a0f0b3_1"),
  participant_id = "12345",
  date = "2021-11-14",
  time = c("14:00:00", "14:00:00", "14:01:00"),
  advertisement_name = c("ace4ec2999d033ac6b76def024d53507dc6eafbb",
                         "3dbd32cf6327dd01fd0fab96d4e202686d5e0e96", NA),
  bluetooth_device_id = c("a94074e7b729cf573aa9e34218c4318b04b62560",
                          "9b0cbfcbee534e034b1dec3b2057f7c310bf01d9", NA),
  bluetooth_device_name = c("915e4ac54400e2304392f1a2d123561853295e50",
...
test_that("Calendar", {
 db_test("Calendar", true_data = tibble::tibble(
  measurement_id = c(paste0("7b050885-ad2f-3cd3-9217-5eb876e3c5c1_", 1:2),
                     "5bafebd2-3d01-2355-0ad4-5e1f697b690f_1"),
  participant_id = "12345",
  date = "2021-11-14",
  time = c("14:00:00", "14:00:00", "14:01:00"),
  event_id = c(279L, 262L, NA),
  calendar_id = c(3L, 8L, NA),
  title = c("f4984b61b560744d74f08ea659bb3a2275537f31",
            "7fb8bab16fd45110007e30e1d6dd4a7f6811bc8d", NA),
  description = c("28a74980d7bebc37dbc9cfa949871ce83edc2b26",
...
test_that("Device", {
 db_test("Device", true_data = tibble::tibble(
  measurement_id = c("bce3c272-3e06-4c84-f533-5bbbeaaac049",
...
test_that("Error", {
 db_test("Error", true_data = tibble::tibble(
  measurement_id = c("df74ca23-3d0f-fcb1-70b9-12b2051c1115",
                     "b1c326ff-e96b-059f-7f1b-72d3384b7222"),
  participant_id = "12345",
  date = "2021-11-14",
  time = c("14:00:00", "14:01:00"),
  message = c(paste("AirQuality Probe Exception: SocketException: Failed host lookup:",
...
test_that("Gyroscope", {
 db_test("Gyroscope", true_data = tibble::tibble(
  measurement_id = c(paste0("ce0cc1bf-f071-91b5-19c8-4b3b789e64a2_", 1:5),
                     "06bce1d4-b4a9-d1f1-2f06-cc76d872a61d_1"),
  participant_id = "12345",
  date = "2021-11-14",
  time = c("14:00:00.000", "14:00:00.200", "14:00:00.400", "14:00:00.600",
           "14:00:00.800", "14:00:01.000"),
  x = c(-0.0003741947002708912, -0.000054615666158497336, 0.0001584370620548725,
        0.0001584370620548725, 0.0001584370620548725, NA),
  y = c(-0.003209952265024185, -0.0006000570137985051, -0.0001739516155794263,
        -0.00038700434379279613, -0.00038700434379279613, NA),
  z = c(0.021946871653199197, 0.00010896776802837849, 0.00010896776802837849,
        0.00010896776802837849, 0.00010896776802837849, NA)
 ))
})
...
test_that("Light", {
 db_test("Light", true_data = tibble::tibble(
  measurement_id = c("23d93a4e-7ff8-f057-828d-c728c9466f8a",
...
test_that("Location", {
 db_test("Location", true_data = tibble::tibble(
  measurement_id = c("24d0a408-a87c-2ea4-80c0-23a964a16675",
                     "62db94d7-2155-f867-b7c4-f878681ec736"),
  participant_id = "12345",
  date = "2021-11-14",
  time = c("14:00:00", "14:01:00"),
  latitude = c(paste0("beb3005c45cb250b9841b9aae0637fa5610c45ce206ca38494f7f74a6cbdf8566cdf0d8967e",
  "9422bb857a4d87c2e6c08d85f162525a8f9d6a72a8"), NA),
  longitude = c(paste0("8a4f368c36ab8e6e9dcbca9d7ef88a313f48e841e77746c54f1ca5b1887cd56f123d8ba36e",
  "92465e5483ebbd335b242ff8fade5b31a43e20dd851"), NA),
...
test_that("Memory", {
 db_test("Memory", true_data = tibble::tibble(
  measurement_id = c("7f2fbe8b-af33-0078-137e-ed21c0f97b10",
...
test_that("Mobility", {
 db_test("Mobility", true_data = tibble::tibble(
  measurement_id = c("95d7c9e8-bf65-1d89-264a-6d43e9c98e25",
...
test_that("Noise", {
 db_test("Noise", true_data = tibble::tibble(
  measurement_id = c("5fc9ecdf-c62c-955c-e59d-d6c4a2ee9a2a",
...
test_that("Pedometer", {
 db_test("Pedometer", true_data = tibble::tibble(
  measurement_id = c("5ea89a50-777c-11eb-8c91-3f093a6e6e87",
...
test_that("Screen", {
 db_test("Screen", true_data = tibble::tibble(
  measurement_id = c("c40b2459-e598-8fdb-7925-e55ed3048baf",
...
test_that("Weather", {
 db_test("Weather", true_data = tibble::tibble(
  measurement_id = c("d42140e5-d91b-8ec5-87fd-f003e4fdcdf3",
...
test_that("Wifi", {
 db_test("Wifi", true_data = tibble::tibble(
  measurement_id = c("59ce179b-3a3c-42d8-6e5c-6a1030545e92",
