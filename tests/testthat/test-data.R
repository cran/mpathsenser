...
test_that("Gyroscope", {
  db_test("Gyroscope", true_data = tibble::tibble(
    ...
    date = "2021-11-14",
    time = c(
      "14:00:00.000", "14:00:00.200", "14:00:00.400", "14:00:00.600",
      "14:00:00.800", "14:00:01.000"
    ),
    x = c(
      -0.0003741947002708912, -0.000054615666158497336, 0.0001584370620548725,
      0.0001584370620548725, 0.0001584370620548725, NA
    ),
    y = c(
      -0.003209952265024185, -0.0006000570137985051, -0.0001739516155794263,
      -0.00038700434379279613, -0.00038700434379279613, NA
    ),
    z = c(
      0.021946871653199197, 0.00010896776802837849, 0.00010896776802837849,
