  ...
  db_test(
    ...
    true_data = tibble::tibble(
      ...
      title = c(
        ...
        "7fb8bab16fd45110007e30e1d6dd4a7f6811bc8d",
        NA
      ),
      description = c(
        "28a74980d7bebc37dbc9cfa949871ce83edc2b26",
        "3d4e4a2d7dac35a3264e7026b798c7dde2b39675",
        NA
      ),
